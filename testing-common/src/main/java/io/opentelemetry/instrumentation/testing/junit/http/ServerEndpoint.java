...
public class ServerEndpoint {
  ...
  public static final ServerEndpoint ERROR = new ServerEndpoint("error-status", 500, "controller error"); // "error" is a special path for some frameworks
  public static final ServerEndpoint EXCEPTION = new ServerEndpoint("exception", 500, "controller exception");
  public static final ServerEndpoint NOT_FOUND = new ServerEndpoint("notFound", 404, "not found");
  public static final ServerEndpoint CAPTURE_HEADERS = new ServerEndpoint("captureHeaders", 200, "headers captured");
  public static final ServerEndpoint CAPTURE_PARAMETERS = new ServerEndpoint("captureParameters", 200, "parameters captured");

  // TODO: add tests for the following cases:
  public static final ServerEndpoint QUERY_PARAM = new ServerEndpoint("query?some=query", 200, "some=query");
  ...
  public static final ServerEndpoint AUTH_ERROR = new ServerEndpoint("basicsecured/endpoint", 401, null);
  public static final ServerEndpoint INDEXED_CHILD = new ServerEndpoint("child", 200, "");
  public static final ServerEndpoint HTML_PRINT_WRITER = new ServerEndpoint(
      "htmlPrintWriter",
      200,
      "<!DOCTYPE html>\n"
          + "<html lang=\"en\">\n"
          ...
          + "</body>\n"
          + "</html>");
  public static final ServerEndpoint HTML_SERVLET_OUTPUT_STREAM = new ServerEndpoint(
